...
<html>
	...
	<div id="FullMenu" style="position:fixed; float:left; width:5%; height:98vh; background: #000;">
			...
			<div id="Link4" style="float:left; width:100%; height:11%; margin-bottom:2%; background:#000; color:#FFF;"><a href="/protected_page.php" style="width: auto;font-size: 2vw;margin-left: 2.8vw;line-height: 5vw; color:#FFF;">Home</a></div>
	...
	<div style="float:left; width:50%; margin-left:10vw;">
            <p>Coming Soon.</p>
	</div>
		<div id="JobBox" style="float:left; width:50%; height:100px; margin-left:10vw;">
