...
$colCount = $mysqli->query("SELECT currentCount FROM syscount WHERE countName = 'taskCount'");
...
$columnCount++;
$updateColumn = $mysqli->query("UPDATE syscount SET currentCount = ".$columnCount." WHERE countName = 'taskCount'");
